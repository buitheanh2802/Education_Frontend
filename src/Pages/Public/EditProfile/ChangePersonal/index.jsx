          ...
          return (
            <div className="flex my-[5px]">
              <input
                type="checkbox"
                value={item.value}
                onChange={(e) => handleAddHobby(e, item.label)}
                defaultChecked={hobbies?.find(
                  (ele) => ele.toLowerCase() === item.label.toLowerCase()
                )}
                className="px-[6px] py-[8px] mx-[10px] border rounded-[5px] my-[5px] outline-none"
                id=""
              />
          ...
          return (
            <div className="flex my-[5px]">
              <input
                type="checkbox"
                value={item.value}
                onChange={(e) => handleAddSkill(e, item.label)}
                defaultChecked={skills?.find(
                  (ele) => ele.toLowerCase() === item.label.toLowerCase()
                )}
                className="px-[6px] py-[8px] mx-[10px] border rounded-[5px] my-[5px] outline-none"
                id=""
        ...
        <div className="w-full">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mx-auto w-[220px]">
              ...
              <input
                class="block w-full text-sm text-gray-500 file:mr-2 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-violet-700 hover:file:bg-blue-200"
                type="file"
                onChangeCapture={() => {
                  clearErrors("photo");
                }}
            ...
            <div className="py-[5px]">
              ...
              <input
                ...
                disabled
                className="px-[6px] w-[100%] py-[8px] border rounded-[5px] my-[5px]"
              />
            </div>
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Email:</p>
              <input
            ...
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Ngày sinh:</p>
              <input
                type="date"
            ...
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Địa chỉ:</p>
              <input
                type="text"
            ...
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Mô tả:</p>
              <textarea
                defaultValue={profile?.descriptions}
                rows={6}
                onChangeCapture={() => {
            ...
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Sở thích:</p>
              <form id="hobbies" className="grid grid-cols-3">
                {renderHobbies()}
              </form>
            </div>
            <div className="py-[5px]">
              <p className="text-gray-800 text-[15px] py-[5px]">Kỹ năng:</p>
