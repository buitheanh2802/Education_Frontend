...
const ChallengeCatePage = () => {
    ...
    return (
        <div className="container mx-auto mt-[55px] py-[20px]">
            ...
            <div className="mt-[25px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] mt-[10px]">
                    <div className="shadow-sm hover:shadow-md duration-300 bg-white rounded  course-item p-[25px] relative border" >
                        ...
                        <div className="w-full" >
                            <div className="flex justify-between items-center mt-[12px]">
                                <span className="text-[20px] font-bold  cursor-pointer text-gray-800 hover:text-blue-600">Bước 1: Chọn một thử thách</span>
                            </div>
                    ...
                    <div className="shadow-sm hover:shadow-md duration-300 bg-white rounded  course-item p-[25px] relative border" >
                        ...
                        <div className="w-full" >
                            <div className="flex justify-between items-center mt-[12px]">
                                <span className="text-[20px] font-bold  cursor-pointer text-gray-800 hover:text-blue-600">Bước 2: Làm việc một mình hoặc với một nhóm</span>
                            </div>
                    ...
                    <div className="shadow-sm hover:shadow-md duration-300 bg-white rounded  course-item p-[25px] relative border" >
                        ...
                        <div className="w-full" >
                            <div className="flex justify-between items-center mt-[12px]">
                                <span className="text-[20px] font-bold  cursor-pointer text-gray-800 hover:text-blue-600">Bước 3: Gửi các giải pháp của bạn và đưa ra phản hồi</span>
                            </div>
            ...
            <div className="mt-[25px]" >
                <h3 className="text-[20px] font-medium text-blue-900">Các loại bài tập</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] mt-[10px]">
                    {isLoading &&
                        <>
