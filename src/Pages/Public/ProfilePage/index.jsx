          ...
          <div className="py-[5px] mx-[10px]">
            <div className="py-[10px] bg-[#BEE3F8]">
              <Link className="block">
                <img
                  className="mx-auto max-h-[80px] rounded-full"
                  width="80px"
              ...
              <div className=" divide-y divide-light-blue-400 pb-[10px]">
                <div className="grid md:grid-cols-3 lg:grid-cols-3 lg:gap-[3px] md:gap-[10px] my-[20px]">
                  ...
                  <div className="mt-2 md:text-right">
                    <button className="bg-[#fff] border border-[#0d61c7] hover:bg-[#0d61c7] hover:text-[#BEE3F8] text-[#0d61c7] rounded md:px-[10px] md:py-[5px] md:text-[14px] px-[10px] py-[5px] sm:text-[14px] lg:px-[8px] lg:py-[5px] lg:text-[10px] xl:px-[8px] xl:py-[5px] xl:text-[14px] ">
                      + Theo dõi
                    </button>
                  </div>
                </div>
