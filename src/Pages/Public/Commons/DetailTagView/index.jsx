                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <div className=" inline-block">
                                                ...
                                                <div className=" inline-block">
                                                    <span className="col-span-4 text-[13px] text-[#707885]">{item?.createdAt}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex gap-[5px] my-[10px]">
                                                {item?.tags.map((tag, indexTag) => {
                                                    return (
                                                        <>
                                                            <div>
                                                                <Link key={indexTag} to={tag?.slug} className="block hover:bg-gray-300 bg-[#e7e7e7] px-[10px] py-[2px] text-[#5f5f5f] lg:text-[12px] rounded-[3px]" >{tag?.name}</Link>
                                                            </div>
                                                        </>
                                                    )
                                                })}
