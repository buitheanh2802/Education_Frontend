...
const Footer = () => {
    return (
        <footer className="pt-[30px] text-center md:text-left">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 xl:grid-cols-5 xl:flex xl:justify-between text-gray-900 md:gap-x-[50px] xl:gap-x-[30px]">
                <ul className="md:col-span-2 xl:flex-[2.5] md:order-1 xl:order-1">
                ...
                <ul className="xl:flex-[1] mt-[20px] md:order-3 xl:order-3">
            ...
            <ul className="container mx-auto text-center xl:text-left mt-[30px]"><li className="mb-[15px] text-gray-500">© 2021 <Link to={path.HOME} className="text-blue-500 hover:text-blue-700">eduford</Link> đăng ký bản quyền</li></ul>
        </footer>
    )
}
