    ...
    return (
        <div className="container mx-auto mt-[85px] py-[20px]">
            ...
            <div className="mx-auto w-[50%] mb-[20px]">
                <img className="w-[100%] mx-auto py-[10px]" src={NotFound} alt="Not-found" />
            </div>
            <div className="text-center py-[15px]">
                ...
                <div className="font-semibold md:text-[30px] sm:text-[26px] text-[20px] py-[10px]">Liên hệ với chúng tôi</div>
                <div className="md:text-[16px] sm:text-[12px] text-[10px] text-[#4A5568] pb-[5px]">để chất lượng học tập ngày càng nâng cao, nếu bạn có thắc mắc hoặc có ý kiến đóng góp, hãy liên hệ ngay với chúng tôi thông qua các nên tảng sau đây.</div>
