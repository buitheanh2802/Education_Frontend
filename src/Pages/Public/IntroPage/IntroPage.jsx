                    ...
                    <div className="flex items-center">
                        <div className="mt-5 md:mt-0">
                            ...
                            <p className="mt-2 lg:text-[16px] sm:text-[13px]  text-[16px] lg:leading-[24px] text-justify">
                                ...
                                phép người dùng học, thực hành, chia sẻ, hỏi đáp và đánh giá kỹ năng lập trình của
                                mình thông qua các bài tập thực hành, các bài quiz để người dùng có thể cải thiện kỹ
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[50px] xl:gap-[100px] mt-8 lg:mt-[50px] ">
                    <div className=" col-span-1">
                        ...
                        <p className="lg:text-[16px] pt-[10px] leading-[24px] md:text-[13px] text-justify">
                            ...
                            với các bài thực hành từ cơ bản đến nâng cao và bài viết chia sẻ kiến thức phù hợp với tất cả mọi người.
                            DevStar giúp người dùng học và thực hành lập trình một cách dễ dàng và hiệu quả.
                            <br />
                        ...
                        <div className="flex  pl-[14px] pr-[22px] bg-[#BEE3F8] py-[25px]">
                            ...
                            <div className="text-left pl-[20px]">
                                ...
                                <p className="text-[14px] font-normal leading-[20px]">
                                    Các bài chia sẻ, khóa học trực tuyến từ cơ bản đến nâng cao dành cho mục
                        ...
                        <div className="flex  pt-[25px]  pl-[19px] pb-[20px]  pr-[17px] bg-[#BEE3F8]">
                            ...
                            <div className=" ml-[20px]">
                                ...
                                <p className="pt-[2px] text-[14px] leading-[20px] font-normal">
                                    ...
                                    cho các tổ chức và hỗ trợ các cá nhân lưu trữ các mục tiêu của họ.
                                </p>
                            </div>
                        </div>
                    </div>
