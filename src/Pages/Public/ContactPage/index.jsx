        ...
        <div className="container mx-auto mt-[30px] ">
            <div className="grid lg:grid-cols-2 gap-[30px] ">
                <div className="bg-white  border rounded-[10px] ">
                    ...
                    <form action="" className="px-[20px] md:px-[70px] pb-[40px]">
    ...
    <div className="">
      <div className="relative text-center ">
        ...
        <div className="absolute text-center top-1/2 translate-x-[150%] translate-y-[50%] sm:top-1/2 sm:translate-x-[8%] md:top-1/2 lg:top-1/2 md:translate-x-[25%] lg:translate-x-[25%] lg:translate-y-[17%] xl:top-1/2 xl:translate-x-[35%]  xl:translate-y-[8%]">
          <h3 className="font-semibold sm:text-[20px] md:text-[24px] lg:text-[30px] xl:text-[32px] lg:leading-[54px] md:leading-[35px] text-white">
            Liên hệ - Góp ý
          </h3>
          <p className=" hidden md:block md:text-[16px] lg:text-[20px] lg:leading-[36px] md:leading-[25px] text-white">
      ...
      <div className="container mx-auto mt-[30px]">
        <div className="grid lg:grid-cols-2 gap-[30px]">
          <div className="bg-white  border rounded-[10px]">
            <h4 className="pt-[20px] text-[24px] leading-[36px] font-light text-center bg-[#E3DEDE] rounded-t-[10px] pb-[13px]">
              GỬI THÔNG TIN LIÊN HỆ - GÓP Ý
            </h4>
            <form action="" className="px-[40px] md:px-[70px] pb-[40px]">
              <p className="mt-[20px] text-left text-[18px] leading-[26px]">
                Góp ý hoặc liên hệ với DevStar nếu như bạn có nhu cầu về dịch vụ
                hoặc thắc mắc khác.
              </p>
              <div className="grid grid-cols-2 gap-[25px]">
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    class="text-[14px] leading-[24px] border rounded-[4px] py-[7px] pl-[18px] italic font-light w-full text-[#4B4848] mt-[10px]"
                  />
>>>>>>> 712aed61ec7c6422b7dcb1d751d04b09eab53c89
                </div>
                <div className="col-span-2">
                  <label className="text-[16px] text-left leading-[24px] mt-[10px]">
                    Nội dung
          ...
          <div className="bg-white  border rounded-[10px]">
            ...
            <div className="px-[40px] md:px-[70px] pb-[40px]">
              ...
              <div className="flex mt-[10px] items-center">
                ...
                <div className="ml-[10px]">
                  <h5>Facebook</h5>
                  <a href="" className="text-[#1B57F2] hover:underline">
