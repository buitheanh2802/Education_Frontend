    ...
    return (
        <div className="nav bg-white border-b text-[15px] p-[10px] gap-3 grid grid-cols-[60px,1fr,3fr,1.2fr,0.5fr] items-center">
            ...
            <div className="text-center flex justify-center">
                <button onClick={() => handelDelete(data?._id)} className="h-[35px] px-2 flex items-center disabled:bg-gray-400 mr-[5px] text-red-400 hover:text-blue-600 rounded-md" title="Chỉnh sửa">
