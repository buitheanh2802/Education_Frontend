    ...
    <div>
      <div className="nav bg-white border-b text-[15px] p-[10px] grid grid-cols-[60px,1.5fr,1fr,0.75fr,0.75fr,1.2fr]">
        ...
        <div className="font-medium mr-[30px]">
          <Link className="hover:underline text-blue-500" to={`/tag/${slug}`}>
            {name}
          </Link>
        </div>
        ...
        <div className="flex justify-center gap-[10px]">
          <button
            ...
            className="px-[15px] py-[5px] text-white bg-red-500 hover:bg-red-800 rounded-md flex "
          >
            {loading.success && (
          ...
          <button
            onClick={toggleEdit}
            className="px-[15px] py-[5px] text-white bg-blue-500 hover:bg-blue-800 rounded-md"
          >
            Sửa
          </button>
          <ModalEdit
