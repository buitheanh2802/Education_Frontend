                        ...
                        <div className="relative">
                            ...
                            {isPopup && <div className="absolute top-[calc(100%+15px)] right-0 w-[200px] pt-[12px]">
                                ...
                                <ul className="bg-white text-[#333] text-[15px] rounded-[3px] font-normal p-[5px] shadow-lg border border-solid border-gray-300">
                                    ...
                                    {profile?.role && <Link onClick={() => setIsPopup(!isPopup)} to={path.HOME}><li className="px-[10px] py-[5px] hover:bg-gray-100 duration-300 rounded-[3px] flex items-center text-[#333]"><Icon.Home className="w-[20px] h-[20px] fill-current" /> <p className="ml-[10px]">Người dùng</p></li></Link>}
