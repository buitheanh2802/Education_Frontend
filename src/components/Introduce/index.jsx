...
const Introduce = () => {
    return (
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-[15px] sm:gap-[30px] mt-[60px]">
            ...
            <div className="border border-gray-100 cursor-default rounded-[15px] bg-[#FED7D7] bg-opacity-[25%] px-[38px] py-[25px] text-center shadow hover:shadow-lg duration-300">
