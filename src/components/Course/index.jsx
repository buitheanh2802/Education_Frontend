...
const Course = () => {
    return (
        <div className="rounded-[15px] text-gray-900 shadow-md bg-gray-100">
            <div className="bg-center bg-cover lg:h-[230px] rounded-t-[15px]" style={{backgroundImage: `url(${Khoa_hoc})`}}></div>
            <div className="p-[20px]">
                ...
                <p className="text-[16px] text-gray-600">Khoá học này sẽ giúp bạn hiểu được cách thức hoạt động của mã javascript, cách để xây dựng một ưngs dụng javascript chuyên nghiệp.</p>
                <div className="flex justify-between items-center text-[14px] mt-[20px]">
