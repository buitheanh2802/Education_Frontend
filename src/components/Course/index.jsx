    ...
    return (
        <div className="rounded-[15px] text-gray-900 shadow hover:shadow-lg duration-300 bg-gray-100">
            ...
            <div className="p-[20px] h-[50%]">
                ...
                <p className="text-[16px] text-gray-600 mb-[20px]">Khoá họ c này sẽ giúp bạn hiểu được cách thức hoạt động của mã javascript, cách để xây dựng một ưngs dụng javascript chuyên nghiệp.</p>
